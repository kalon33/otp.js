...
var detectLanguage = function() {
    ...
    var availible_languages = {"de":true, "fr":true, "it":true, "sl":true, "en":true};
    var detectLanguage = null;
    ...
    if (navigator.languages) {
        ...
        detectLanguage = _.find(navigator.languages, function getLang(ilang) {
            console.log("currentLang", ilang, availible_languages);
            return _.has(availible_languages, ilang);
        }, availible_languages);
    } else {
        detectLanguage = (navigator.language || navigator.userLanguage);
        //User wanted language isn't among languages we support
        if (!_.has(availible_languages, detectLanguage)) {
            detectLanguage = "en";
        }
    }
